...
{
    rt_uint8_t i= 0;
    rt_uint8_t AddrHigh,AddrMid,AddrLow ; //字高、中、低地址
    rt_uint32_t FontAddr=0; //字地址
    rt_uint32_t BaseAdd=0; //字库基地址
    rt_uint8_t n,d;// 不同点阵字库的计算变量
    rt_uint8_t x_temp=x;
    switch(zk_num)
    {
        // n:字符所占字节数  d：字间距
