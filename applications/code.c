...
*******************************************************************************/
rt_uint16_t UnicodeToGB2312(rt_uint16_t unicode)//用二分查找算法
{
...
/* test the CPU endian                                                                     */
/************************************************************************/
static rt_uint8_t TestIsBigEndian(void)
{
    rt_uint16_t temp=0x1234;
    rt_uint8_t *pChar=(rt_uint8_t *)&temp;
...
void GB2312ToUnicode_Str(rt_uint16_t * const pOutUnicodeStr,rt_uint8_t * const pGB2312Str)
{
    ...
    if(TestIsBigEndian())
    {
        while (*pChar)
        {   rt_kprintf("coming1\n");
            pGb2312=(rt_uint16_t *)pChar;
           /* if(*pGb2312<=0xA000){
                *pUnicode=*pGb2312;
            }
            else*/ *pUnicode=GB2312ToUnicode(*pGb2312);
            pUnicode++;
            pChar+=2;
        }
        pUnicode=0;
    ...
    else
    {
        ...
        {   //rt_kprintf("coming2\n");
            ...
            rt_kprintf("<%x>",temp);
            if(temp<0xa000){
                *pUnicode=temp&0x00ff;
            }
            else *pUnicode=GB2312ToUnicode(temp);
            pUnicode++;
            pChar++;
        }
        pUnicode=0;
