...
rt_int8_t phone_real[11]="18174167698";//{0};//"18174167698";
...
int adc_sample(){
    ...
    adc_thread=rt_thread_create(
            "adc", adc_entry, RT_NULL, 1024, 18, 5);
    rt_thread_startup(adc_thread);

    rt_pin_mode(KEY, PIN_MODE_INPUT_PULLUP);
    key_thread=rt_thread_create("key",key_entry, RT_NULL, 1024, 17, 5);
