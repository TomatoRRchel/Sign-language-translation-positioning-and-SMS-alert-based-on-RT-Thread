...
#define AI_NETWORK_MODEL_SIGNATURE     "9d90b43ba0197f0380af1df4ad5e05df"
...
#define AI_TOOLS_DATE_TIME   "Wed Jul 19 16:28:10 2023"
...
AI_STATIC ai_array dense_6_bias_array;   /* Array #4 */
...
AI_STATIC ai_array nl_6_output_array;   /* Array #17 */
AI_STATIC ai_array dense_7_output_array;   /* Array #18 */
...
AI_STATIC ai_tensor dense_6_bias;   /* Tensor #4 */
...
AI_STATIC ai_tensor nl_6_output;   /* Tensor #18 */
AI_STATIC ai_tensor dense_7_output;   /* Tensor #19 */
...
AI_STATIC_CONST ai_tensor_chain nl_6_chain;   /* Chain #4 */
AI_STATIC_CONST ai_tensor_chain dense_7_chain;   /* Chain #5 */
...
AI_STATIC ai_layer_nl nl_6_layer; /* Layer #4 */
AI_STATIC ai_layer_dense dense_7_layer; /* Layer #5 */
...
/* Array#12 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_6_input_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 8100, AI_STATIC)

/* Array#13 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_0_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 61952, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 42, 2), AI_STRIDE_INIT(4, 4, 4, 256, 10752),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 88, 2), AI_STRIDE_INIT(4, 4, 4, 128, 11264),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 23104, 64, 1, 1), AI_STRIDE_INIT(4, 4, 92416, 5914624, 5914624),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 90, 90), AI_STRIDE_INIT(4, 4, 4, 4, 360),
  1, &conv2d_6_input_output_array, NULL)

/* Tensor #13 */
AI_TENSOR_OBJ_DECLARE(
  conv2d_0_output, AI_STATIC,
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 44, 44), AI_STRIDE_INIT(4, 4, 4, 128, 5632),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 21, 21), AI_STRIDE_INIT(4, 4, 4, 256, 5376),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 19, 19), AI_STRIDE_INIT(4, 4, 4, 256, 4864),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 23104, 1, 1), AI_STRIDE_INIT(4, 4, 4, 92416, 92416),
  1, &conv2d_4_output_array, NULL)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 275968, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &conv2d_6_input_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_2_scratch0_array.data = AI_PTR(activations + 253440);
    conv2d_2_scratch0_array.data_start = AI_PTR(activations + 253440);
    conv2d_0_scratch0_array.data = AI_PTR(activations + 253440);
    conv2d_0_scratch0_array.data_start = AI_PTR(activations + 253440);
    conv2d_6_input_output_array.data = AI_PTR(NULL);
    conv2d_6_input_output_array.data_start = AI_PTR(NULL);
    conv2d_0_output_array.data = AI_PTR(activations + 5632);
    conv2d_0_output_array.data_start = AI_PTR(activations + 5632);
    conv2d_2_output_array.data = AI_PTR(activations + 0);
    conv2d_2_output_array.data_start = AI_PTR(activations + 0);
    conv2d_4_output_array.data = AI_PTR(activations + 112896);
    conv2d_4_output_array.data_start = AI_PTR(activations + 112896);
    dense_6_output_array.data = AI_PTR(activations + 0);
    dense_6_output_array.data_start = AI_PTR(activations + 0);
    nl_6_output_array.data = AI_PTR(activations + 256);
    nl_6_output_array.data_start = AI_PTR(activations + 256);
    dense_7_output_array.data = AI_PTR(NULL);
    dense_7_output_array.data_start = AI_PTR(NULL);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_7_bias_array.data = AI_PTR(weights + 6139136);
    dense_7_bias_array.data_start = AI_PTR(weights + 6139136);
    dense_7_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_7_weights_array.data = AI_PTR(weights + 6137856);
    dense_7_weights_array.data_start = AI_PTR(weights + 6137856);
    dense_6_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_6_bias_array.data = AI_PTR(weights + 6137600);
    dense_6_bias_array.data_start = AI_PTR(weights + 6137600);
    dense_6_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_6_weights_array.data = AI_PTR(weights + 222976);
    dense_6_weights_array.data_start = AI_PTR(weights + 222976);
